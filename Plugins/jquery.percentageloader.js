...
(function ($) {
    ...
    gradient.src = "Images/progress.png";
    ...
    $.fn.percentageLoader = function (params) {
        ...
        * (but we leave a little room so the borders aren't truncated) */
        ...
        /* Bottom left angle */
        startAngle = 1.5; //2.1707963267949;
        /* Bottom right angle */
        endAngle = 7.8; //0.9707963267949 + (Math.PI * 2.0);
        ...
        * than true / false */
	    ...
	    ctx.stroke();
            ...
            (function () {
                ...
                percentageText.style.top = "5px"; //((settings.height / 2) - (fontSize / 2)).toString() + 'px';
                percentageText.style.color = '#51B1EB';
                percentageText.style.font = '140px Droid'; //fontSize.toString() + 'px Droid';
                ...
                percentageText.innerHTML = "E";

                /* Calculate font and placement of small 'value' text */
                smallSize = cX / 5.5;
                valueText.style.color = '#51B1EB';
                valueText.style.font = smallSize.toString() + 'px Droid';
